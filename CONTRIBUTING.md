...
> available [Documentation](https://cbueth.de/infomeasure/).

Before you ask a question, it is best to search for
existing [Issues](https://github.com/cbueth/infomeasure/issues) that might help you.
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  the [documentation](https://cbueth.de/infomeasure/). If you are looking for support, you
...
- To see if other users have experienced (and potentially already solved) the same issue
  ...
  error in
  the [bug tracker](https://github.com/cbueth/infomeasure/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/cbueth/infomeasure/issues/new). (Since we can't
...
- Make sure that you are using the latest version.
- Read the [documentation](https://cbueth.de/infomeasure/) carefully and find out if the
...
as [GitHub issues](https://github.com/cbueth/infomeasure/issues).
