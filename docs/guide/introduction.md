...
- Kernel Estimation
- Ordinal Estimation / Permutation Estimation
...
3. Directly importing the {py:class}`Estimator <infomeasure.estimators.base.Estimator>` classes and using them.
...
The {py:func}`results() <infomeasure.estimators.base.Estimator.results>` method returns the global value, if available the local values and its standard deviation.
...
If you are only interested in either the ``glob``, ``local``, or ``std`` value, one can use the corresponding methods separately {py:func}`global_val() <infomeasure.estimators.base.Estimator.global_val>`, {py:func}`local_vals() <infomeasure.estimators.base.Estimator.local_val>`, or {py:func}`std_val() <infomeasure.estimators.base.Estimator.std_val>`.

```{code-cell}
glob = est.global_val()
local = est.local_vals()
std = est.std_val()
glob, local[:10], std
```

One might also return a p-value for the mutual information with {py:func}`p_value() <infomeasure.estimators.base.PValueMixin.p_value>`:
...
*   - Estimator
    - {py:func}`calculate() <infomeasure.estimators.base.Estimator.calculate>` {py:func}`results() <infomeasure.estimators.base.Estimator.results>` {py:func}`global_val() <infomeasure.estimators.base.Estimator.global_val>`
    - {py:func}`local_vals() <infomeasure.estimators.base.Estimator.local_val>`
    - {py:func}`std_val() <infomeasure.estimators.base.Estimator.std_val>`
    - {py:func}`p_value() <infomeasure.estimators.base.PValueMixin.p_value>`
...
- {py:func}`calculate() <infomeasure.estimators.base.Estimator.calculate>`: Calculates the information measure, no return value.
- {py:func}`results() <infomeasure.estimators.base.Estimator.results>`: Returns the global value and if available the local values and its standard deviation.
- {py:func}`global_val() <infomeasure.estimators.base.Estimator.global_val>`: Returns the global value of the information measure.
- {py:func}`local_vals() <infomeasure.estimators.base.Estimator.local_val>`: Returns the local values of the information measure.
- {py:func}`std_val() <infomeasure.estimators.base.Estimator.std_val>`: Returns the standard deviation of the local values.
...
Each method can be directly called on the estimator object, it is not necessary to call the {py:func}`calculate() <infomeasure.estimators.base.Estimator.calculate>` method before calling the other methods, as it is done internally.
Calling {py:func}`results() <infomeasure.estimators.base.Estimator.results>`, {py:func}`global_val() <infomeasure.estimators.base.Estimator.global_val>`, {py:func}`local_vals() <infomeasure.estimators.base.Estimator.local_val>`, or {py:func}`std_val() <infomeasure.estimators.base.Estimator.std_val>` twice will return the same values, as the estimator caches the results.
