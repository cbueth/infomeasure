...
class BaseBonachelaMIEstimator(ABC):
    r"""Base class for Bonachela mutual information estimators.
    ...
    *data : array-like, shape (n_samples,)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        r"""Initialize the Bonachela estimator with specific parameters.
...
class BonachelaMIEstimator(BaseBonachelaMIEstimator, MutualInformationEstimator):
    r"""Estimator for the Bonachela mutual information.
    ...
    *data : array-like, shape (n_samples,)
    ...
    Notes
    -----
    This estimator uses the Bonachela entropy estimator to compute mutual 
    ...
    def _calculate(self):
        ...
        -------
        float
            Bonachela mutual information of the data.
        """
...
class BonachelaCMIEstimator(BaseBonachelaMIEstimator, ConditionalMutualInformationEstimator):
    r"""Estimator for the conditional Bonachela mutual information.
    ...
    *data : array-like, shape (n_samples,)
    ...
    def _calculate(self):
        ...
        -------
        float
            Conditional Bonachela mutual information of the data.
        """
