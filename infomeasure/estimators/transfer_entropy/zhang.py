...
class BaseZhangTEEstimator(ABC):
    r"""Base class for the Zhang transfer entropy.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the BaseZhangTEEstimator.
...
class ZhangTEEstimator(BaseZhangTEEstimator, TransferEntropyEstimator):
    ...
    def _calculate(self):
        """Estimate the Zhang transfer entropy."""
...
class ZhangCTEEstimator(BaseZhangTEEstimator, ConditionalTransferEntropyEstimator):
    r"""Estimator for the Zhang conditional transfer entropy.
    ...
    def _calculate(self):
        """Estimate the Zhang conditional transfer entropy."""
