...
class BaseChaoWangJostTEEstimator(ABC):
    r"""Base class for the ChaoWangJost transfer entropy.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the BaseChaoWangJostTEEstimator.
...
class ChaoWangJostTEEstimator(BaseChaoWangJostTEEstimator, TransferEntropyEstimator):
    ...
    def _calculate(self):
        """Estimate the ChaoWangJost transfer entropy."""
...
class ChaoWangJostCTEEstimator(BaseChaoWangJostTEEstimator, ConditionalTransferEntropyEstimator):
    ...
    def _calculate(self):
        """Estimate the ChaoWangJost conditional transfer entropy."""
