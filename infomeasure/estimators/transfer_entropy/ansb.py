...
class BaseAnsbTEEstimator(ABC):
    r"""Base class for the Ansb transfer entropy.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the BaseAnsbTEEstimator.
...
class AnsbTEEstimator(BaseAnsbTEEstimator, TransferEntropyEstimator):
    r"""Estimator for the Ansb transfer entropy.
    ...
    def _calculate(self):
        """Estimate the Ansb transfer entropy."""
...
class AnsbCTEEstimator(BaseAnsbTEEstimator, ConditionalTransferEntropyEstimator):
    r"""Estimator for the Ansb conditional transfer entropy.
    ...
    def _calculate(self):
        """Estimate the Ansb conditional transfer entropy."""
